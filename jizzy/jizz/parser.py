...
from jizzy.jizz.builder import JizzBuilder, ExpressionList


class Jizz(Grammar[JizzBuilder, ExpressionList]):
    BUILDER = JizzBuilder
    ...
    non_empty_expression_list = NonTerminal()
    ...
    def start(cls) -> NonTerminal:
        return cls.expression_list

    @classmethod
    def rules(cls) -> list[Rule]:
        return [
            Rule(
                callback=cls.BUILDER.identity,
                lhs=cls.expression_list,
                rhs=[*cls.non_empty_expression_list]
            ),
            Rule(
                callback=cls.BUILDER.make_expression_list,
                lhs=cls.expression_list,
                rhs=[]
            ),

            Rule(
                callback=cls.BUILDER.expand_expression_list,
                lhs=cls.non_empty_expression_list,
            ...
            Rule(
                callback=cls.BUILDER.make_statement,
                lhs=cls.expression,
            ...
            Rule(
                callback=cls.BUILDER.make_binary_expression,
                lhs=cls.assignment,
            ...
            Rule(
                callback=cls.BUILDER.make_paren_block,
                lhs=cls.paren_block,
                rhs=[cls.OP, *cls.expression_list, cls.CP]
            ),

            Rule(
                callback=cls.BUILDER.make_brace_block,
                lhs=cls.brace_block,
                rhs=[cls.OB, *cls.expression_list, cls.CB]
            ),

            Rule(
                callback=cls.BUILDER.make_curly_block,
                lhs=cls.curly_block,
            ...
            # Unary * & + -
            Rule(
                callback=cls.BUILDER.make_prefix_expression,
                lhs=cls.base_expression,
            ...
            Rule(
                callback=cls.BUILDER.make_postfix_expression,
                lhs=cls.base_expression,
            ...
            # Function call stuff () [] {}
            Rule(
                callback=cls.BUILDER.make_block_expression,
                lhs=cls.base_expression,
